...
// https://leetcode.com/problems/permutation-in-string/solutions/5008038/permutation-in-string-java-approach-o-n-time-o-1-space-explanation/
...
class PermutationsInString {
    public boolean permutationsInString(String p, String s) {
